          ...
          <tbody>
            ...
            @foreach($gifts as $gift)
                <tr class="bg-white">
                    ...
                    <td class="px-6 py-4 text-center text-gray-500 text-md whitespace-nowrap">{{ $gift->winner != null ? $gift->winner->name : '-' }}</td>
                    <td class="px-6 py-4 text-center text-gray-500 text-md whitespace-nowrap">{{ $gift->winner != null ? $gift->winner->email : '-' }}</td>
                </tr>
            @endforeach
